...
ai_index:
  type: "rights and safeguards"
  theme: "dissent, exit, privacy, AI refusal, due process"
  intent: "to ensure that resonance never becomes conformity or a condition for basic life."
  related_concepts:
...
この文書は、凪の制度・AI・経済・実験に先立つ安全な床を定める。
...
凪は更新され続ける。けれども、自由、尊厳、離脱、非観測、異議の保護は、更新を理由に縮小しない。
