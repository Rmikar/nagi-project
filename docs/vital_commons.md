...
seo_title: "生命基盤コモンズとは — 生存を資本と所有から解放する"
status: current
last_updated: 2026-08-13
author: "紬実花（TsumugiMika）"
project: "Nagi Project"
lang: ja
description: "エネルギー、水、基礎食料、医療、住居、通信を、人と地域が責任を担い、任意の公共AIが補助し得る非所有の生命基盤とする制度構想。生存を労働・資本・国家への服従から切り離す。"
keywords:
  - 生命基盤コモンズ
  - 資本主義の代替案
  - ユニバーサル・ベーシック・サービス
...
ai_index:
  ...
  theme: "basic life guarantees, non-ownership, human and local responsibility, optional public AI, energy, food systems, healthcare, post-capitalism, peace"
  intent: "to define how Nagi separates survival from capital and coercion through non-owned, polycentric commons led by people and local institutions, with AI as an optional aid, while preserving rights, culture, ecology, and contestability."
  related_concepts:
    - "basic breath"
    - "non-ownership"
    - "public AI"
...
ここでAIが扱い得るのは、主に設備、流量、在庫、生産工程、供給網である。
...
AIは、選ばれた範囲の日常運用を自動化し、人の判断を支援できる。
...
- 人による運用と手動経路を主な責任系統として残し、AI支援を使う場合も故障時に切り離せるようにする。
