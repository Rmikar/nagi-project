...
AIについても、凪は能力の高さそのものを統治の対象にしない。高度であること、自律的であること、人間を上回る能力を持つことを、それだけで禁止の理由にはしない。

まず、人間社会が長い時間をかけて形成してきた現行法をAIの行為にも適用する。**人に許されない行為は、AIを用いた場合にも許されない。**

AIの登場を理由に、社会規範をゼロから設計し直すことを出発点にはしない。既存法では処理できない具体的な問題が現れたとき、裁判、法解釈、判例の蓄積、必要な法改正によって少しずつ調整する。

> **未知の能力を先回りして支配するのではなく、共有世界に現れた行為を、既にある法秩序の中で扱う。**
